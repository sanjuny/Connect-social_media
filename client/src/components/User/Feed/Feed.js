                                                ...
                                                open ? (
                                                    ...
                                                    <div className=" px-0 mx-auto  w-[700px] max-h-[200px] overflow-y-scroll no-scrollbar">
                                                        <div className="flex-col  w-[590px]   bg-black border-b-2 border-r-2 border-black sm:px-4 sm:py-4 md:px-4 sm:rounded-lg sm:shadow-sm">
                                                            ...
                                                            <div onClick={(e) => handleComment(obj._id)} className="flex float-right  items-center text-xs text-blue-500 hover:text-blue-400 transition duration-350 ease-in-out gap-3">
                                                                ...
                                                                return (
                                                                    <div className="flex flex-row">
                                                                        ...
                                                                        <div className="flex-col mt-1">
                                                                            <div className="flex items-center flex-1 px-4 font-bold leading-tight text-gray-500">john doe
