    ...
    <div>
      <div class="relative min-h-screen  grid bg-black ">
        <div class="flex flex-col sm:flex-row items-center md:items-start sm:justify-center md:justify-start flex-auto min-w-0 ">
          <div class="landing relative sm:w-1/2 xl:w-3/5 bg-white-500 h-full hidden md:flex flex-auto items-center justify-center p-10 overflow-hidden  text-white bg-no-repeat bg-cover" >
            ...
            <div class="w-full  lg:max-w-2xl md:max-w-md z-10 items-center text-center ">
              <div class=" font-bold leading-tight mb-6 mx-auto w-full content-center flex justify-center items-center ">
                <div>
          ...
          >
            <div class="max-w-xl w-full space-y-12">
              <div class="lg:text-left text-center">
                ...
                <h2 class="mt-6 text-5xl font-bold text-gray-100">
                  Happy Connect...
                </h2>
              </div>
