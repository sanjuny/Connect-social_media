...
import { postAdminLogin } from '../../../Api/AdminLogin';
...
function AdminLogin() {
  ...
  return (
    ...
    <div class="flex items-center justify-center h-screen bg-gradient-to-r from-gray-800 bg-gray-500">
      <div class="w-96 flex-col border bg-white px-6 py-14 shadow-md rounded-[4px] ">
        ...
        <form onSubmit={handleSubmit(onSubmit)}>
          ...
          <button class="mt-5 w-full border p-2 bg-gradient-to-r from-gray-800 bg-gray-500 text-white rounded-[4px] hover:bg-slate-400 scale-105 duration-300">Sign in</button>
        </form>
